  ...
  return (
    <div id="linked-accounts">
      ...
      {isPending ? (
        ...
        <div className="flex items-center gap-3 rounded-xl border border-gray-700/70 bg-gray-800/30 px-4 py-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500">
              ...
              push config changes for you, instead of you reinstalling by hand.
            </p>
          </div>
          <Button intent="gray-outline" onClick={linkModal.open}>
            Link an account
          </Button>
        </div>
      )}
...
function LinkedAccountCard({
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border-2 border-gray-700 bg-gradient-to-br from-gray-800/50 to-gray-800/30 p-3">
