  ...
  defaultCredentials: {
    ...
    description: {
      ...
      env:
        ...
        'Service IDs: `realdebrid`, `alldebrid`, `premiumize`, `debridlink`, `torbox`, `offcloud`, `putio`, `easynews`, `easydebrid`, `debrider`, `pikpak`, `seedr`, `nzbdav`, `altmount`, `stremthru_newz`, `stremthru_torrent`. ' +
