...
export const UserDataSchema = z.object({
  ...
  syncedPreferredRegexUrls: z.array(z.string()).optional(),
  syncedExcludedRegexUrls: z.array(z.string()).optional(),
  syncedIncludedRegexUrls: z.array(z.string()).optional(),
  syncedRequiredRegexUrls: z.array(z.string()).optional(),
