...
describe('TMDB episode details for enriched anime requests', () => {
  for (const fixture of [
    ...
    {
      name: 'no TMDB mapping preserves the enriched season',
      id: 'kitsu:1:4',
      parentSeason: 17,
      parentOffset: 41,
      tmdb: undefined,
    ...
    {
      name: 'TMDB offset without a season preserves the enriched season',
      id: 'mal:1:4',
      parentSeason: 17,
      parentOffset: 51,
      tmdb: { fromEpisode: 41 },
    ...
    {
      name: 'target season without offset uses upstream entry mapping',
      id: 'kitsu:1:4',
      parentSeason: 17,
      parentOffset: 41,
      tmdb: { seasonNumber: 2 },
