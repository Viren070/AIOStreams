...
const CUSTOM_REALDEBRID_SERVICE = 'custom_realdebrid';
...
> = {
  ...
  [CUSTOM_REALDEBRID_SERVICE]: {
    id: CUSTOM_REALDEBRID_SERVICE,
    name: 'Custom RealDebrid',
    shortName: 'CRD',
    knownNames: ['CRD', 'Custom RealDebrid', 'Custom Real-Debrid'],
    signUpText:
      'Connect to any RealDebrid-compatible API (e.g. a self-hosted server) by providing its base URL and API token.',
    credentials: [
      {
        id: 'url',
        name: 'Base URL',
        description:
          'The base URL of your RealDebrid-compatible API (the server implements the `/rest/1.0/*` endpoints), e.g. http://seedmount:8080 or https://debrid.mydomain.com',
        type: 'string',
        required: true,
      },
      {
        ...
        name: 'API Token',
        description:
          'The bearer token your RealDebrid-compatible server expects in the `Authorization` header.',
        type: 'password',
        required: true,
      },
    ],
