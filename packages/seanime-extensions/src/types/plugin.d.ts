...
declare namespace $ui {
  ...
  interface Settings {
    define<T extends Record<string, any>>(
      name: string,
      defaults: T
    ): DefinedSettings<T>;
  }
  ...
  type AnimePageButtonAction = ActionObject<{ media: $app.AL_BaseAnime }> & {
  ...
  interface Action {
    ...
    newAnimePageDropdownItem(props: {
      label: string;
      style?: Record<string, string>;
    }): ActionObject<{ media: $app.AL_BaseAnime }>;
    ...
    newMediaCardContextMenuItem<F extends 'anime' | 'manga' | 'both'>(props: {
      ...
      media: F extends 'anime'
        ? $app.AL_BaseAnime
        : F extends 'manga'
          ? $app.AL_BaseManga
          : $app.AL_BaseAnime | $app.AL_BaseManga;
    }> & {
     ...
     * @param props - Context menu item properties
     */
    newEpisodeCardContextMenuItem(props: {
      label: string;
      style?: Record<string, string>;
    }): ActionObject<{ episode: $app.Anime_Episode }>;
  ...
  type FlexComponentFunction = {
    ...
    (
      items: any[],
      props?: { gap?: number; direction?: 'row' | 'column' } & ComponentProps
    ): void;
  };
  ...
  type SwitchComponentFunction = {
    ...
    (
      label: string,
      props?: { side?: 'left' | 'right' } & FieldComponentProps<boolean>
    ): void;
  };
  ...
  type DropdownMenuItemComponentFunction = {
    ...
    (
      item: any,
      props?: { onClick?: string; disabled?: boolean } & ComponentProps
    ): void;
  };
  ...
  type TabsTriggerComponentFunction = {
    ...
    (props: { item: any; value: string }): void;
  };
  ...
  type ImgComponentFunction = {
    ...
    (
      src: string,
      props?: { alt?: string; width?: string; height?: string } & ComponentProps
    ): void;
  };
  ...
  interface DOM {
    ...
    asElement(
      elementId: string
    ): Omit<DOMElement, 'tagName' | 'attributes' | 'innerHTML'>;
  ...
  interface Anime {
    ...
    registerEntryEpisodeTab(options: {
      ...
      onEpisodeCollection?: (event: {
        ...
        | $app.Anime_EpisodeCollection
        | undefined
        | Promise<$app.Anime_EpisodeCollection | undefined>;
    ...
    getAnimeMetadata(
      ...
      mediaId: number
    ): Promise<$app.Metadata_AnimeMetadata | undefined>;
    ...
    getEntryDownloadInfo(
      mediaId: number
    ): Promise<$app.Anime_EntryDownloadInfo>;
    ...
    getEpisodeCollection(
      mediaId: number
    ): Promise<$app.Anime_EpisodeCollection>;
  ...
  interface Continuity {
    ...
    updateWatchHistoryItem(
      mediaId: number,
      watchHistoryItem: $app.Continuity_WatchHistoryItem
    ): void;
    ...
    getWatchHistoryItem(
      mediaId: number
    ): $app.Continuity_WatchHistoryItem | undefined;
  }
  ...
  type TorrentstreamPlaybackType =
    | 'default'
    | 'externalPlayerLink'
    | 'nativeplayer'
    | 'none'
  ...
  interface AutoSelect {
    ...
    search(
      media: $app.AL_BaseAnime,
      episodeNumber: number
    ): Promise<$app.HibikeTorrent_AnimeTorrent[]>;
  ...
  interface TorrentSearch {
    ...
    ): Promise<$app.Torrent_SearchData>;
  }
  ...
  interface AutoDownloader {
    ...
    ): Promise<AutoDownloaderSimulationResult[]>;
  ...
  interface FillerManager {
    ...
    hydrateOnlinestreamFillerData(
      mId: number,
      episodes: $app.Onlinestream_Episode[]
    ): void;
  ...
  interface Debrid {
     ...
     */
    addAndQueueTorrent(
      options: DebridAddAndQueueTorrentOptions
    ): Promise<string>;
    ...
    ): Promise<DebridTorrentInfo>;

    /**
     * Gets parsed file previews for a torrent before manual selection.
     */
    getTorrentFilePreviews(
      options: DebridGetTorrentFilePreviewsOptions
    ): Promise<DebridFilePreview[]>;
...
declare namespace $database {
  namespace localFiles {
     ...
     */
    function findBy(
      filterFn: (file: $app.Anime_LocalFile) => boolean
    ): $app.Anime_LocalFile[];
  ...
  namespace autoDownloaderRules {
    ...
    function update(
      id: number,
      rule: Omit<$app.Anime_AutoDownloaderRule, 'dbId'>
    ): void;
  ...
  namespace autoDownloaderProfiles {
     ...
     */
    function insert(
      profile: Omit<$app.Anime_AutoDownloaderProfile, 'dbId'>
    ): void;
...
declare namespace $app {
  ...
  function getClientPlatform(clientId: string): string;
}
...
declare namespace $ui {
  ...
  interface VideoCore {
     ...
     */
    addEventListener(
      eventType: 'video-loaded',
      callback: (event: VideoLoadedEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-playback-state',
      callback: (event: VideoPlaybackStateEvent) => void
    ): void;
    ...
    addEventListener(
      ...
      callback: (event: VideoPausedEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-resumed',
      callback: (event: VideoResumedEvent) => void
    ): void;
    ...
    addEventListener(
      ...
      callback: (event: VideoEndedEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-error',
      callback: (event: VideoErrorEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-seeked',
      callback: (event: VideoSeekedEvent) => void
    ): void;
    ...
    addEventListener(
      ...
      callback: (event: VideoStatusEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-loaded-metadata',
      callback: (event: VideoLoadedMetadataEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-can-play',
      callback: (event: VideoCanPlayEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'subtitle-file-uploaded',
      callback: (event: SubtitleFileUploadedEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-terminated',
      callback: (event: VideoTerminatedEvent) => void
    ): void;
    ...
    addEventListener(
      ...
      callback: (event: VideoCompletedEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-audio-track',
      callback: (event: VideoAudioTrackEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-subtitle-track',
      callback: (event: VideoSubtitleTrackEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-media-caption-track',
      callback: (event: VideoMediaCaptionTrackEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-fullscreen',
      callback: (event: VideoFullscreenEvent) => void
    ): void;
    ...
    addEventListener(
      eventType: 'video-pip',
      callback: (event: VideoPipEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-anime-4k',
      callback: (event: VideoAnime4KEvent) => void
    ): void;
     ...
     */
    addEventListener(
      eventType: 'video-playlist',
      callback: (event: VideoPlaylistEvent) => void
    ): void;
    ...
    addExternalSubtitleTrack(
      track: Omit<VideoSubtitleTrack, 'index' | 'useLibassRenderer'>
    ): void;
