 ...
 */
export function withControlledInput<T extends FieldBaseProps>(
  InputComponent: React.FC<T>
) {
  return forwardRef<FieldProps, T>((inputProps, ref) => {
...
const withUncontrolledInput = <T extends FieldBaseProps>(
  InputComponent: React.FC<T>
) => {
  return forwardRef<HTMLInputElement, T>((props, ref) => {
...
const TextInputField = React.memo(
  withControlledInput(
    forwardRef<HTMLInputElement, FieldComponent<TextInputProps>>(
      (props, ref) => {
        return <TextInput {...props} value={props.value ?? ''} ref={ref} />;
      }
    )
  )
);

const PasswordInputField = React.memo(
  withControlledInput(
    forwardRef<HTMLInputElement, FieldComponent<PasswordInputProps>>(
      (props, ref) => {
        return <PasswordInput {...props} value={props.value ?? ''} ref={ref} />;
      }
    )
  )
);
...
const TextareaField = React.memo(
  withControlledInput(
    forwardRef<HTMLTextAreaElement, FieldComponent<TextareaProps>>(
      (props, ref) => {
        return <Textarea {...props} value={props.value ?? ''} ref={ref} />;
      }
    )
  )
);
...
//   withControlledInput(
//     forwardRef<HTMLButtonElement, FieldComponent<DatePickerProps>>(
//       ({ onChange, ...props }, ref) => {
//         return <DatePicker {...props} onValueChange={onChange} ref={ref} />;
//       }
//     )
//   )
// );

// const DateRangePickerField = React.memo(
//   withControlledInput(
//     forwardRef<HTMLButtonElement, FieldComponent<DateRangePickerProps>>(
//       ({ onChange, ...props }, ref) => {
//         return (
//           <DateRangePicker {...props} onValueChange={onChange} ref={ref} />
//         );
//       }
//     )
//   )
...
const NativeSelectField = React.memo(
  withControlledInput(
    forwardRef<HTMLSelectElement, FieldComponent<NativeSelectProps>>(
      (props, ref) => {
        ...
        React.useEffect(() => {
          if (
            !get(context.formState.defaultValues, props.name) &&
    ...
    forwardRef<HTMLInputElement, FieldComponent<TextInputProps>>(
      (props, ref) => {
        ...
        const [value, setValue] = React.useState(
          get(context.formState.defaultValues, props.name) || '#000'
        );
          ...
          <TextInput
            ...
            rightAddon={
              <Popover
                ...
                trigger={
                  <div
                    className="cursor-pointer size-7 rounded-[--radius-md]"
...
const SelectField = React.memo(
  withControlledInput(
    forwardRef<HTMLButtonElement, FieldComponent<SelectProps>>(
      ({ onChange, ...props }, ref) => {
        return <Select {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);
...
const NumberField = React.memo(
  withControlledInput(
    forwardRef<HTMLInputElement, FieldComponent<NumberInputProps>>(
      ({ onChange, ...props }, ref) => {
        return <NumberInput {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);

const ComboboxField = React.memo(
  withControlledInput(
    forwardRef<HTMLButtonElement, FieldComponent<ComboboxProps>>(
      ({ onChange, ...props }, ref) => {
        return <Combobox {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);
...
const SwitchField = React.memo(
  withControlledInput(
    forwardRef<HTMLButtonElement, FieldComponent<SwitchProps>>(
      ({ onChange, ...props }, ref) => {
        return <Switch {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);
...
const CheckboxField = React.memo(
  withControlledInput(
    forwardRef<HTMLButtonElement, FieldComponent<CheckboxProps>>(
      ({ onChange, ...props }, ref) => {
        return <Checkbox {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);

const CheckboxGroupField = React.memo(
  withControlledInput(
    forwardRef<HTMLInputElement, FieldComponent<CheckboxGroupProps>>(
      ({ onChange, ...props }, ref) => {
        return <CheckboxGroup {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);
...
const RadioGroupField = React.memo(
  withControlledInput(
    forwardRef<HTMLButtonElement, FieldComponent<RadioGroupProps>>(
      ({ onChange, ...props }, ref) => {
        return <RadioGroup {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);

const RadioCardsField = React.memo(
  withControlledInput(
    forwardRef<
      HTMLButtonElement,
      FieldComponent<
      ...
      (
        ...
        return (
          <RadioGroup
            ...
            stackClass={cn(
              'flex flex-col md:flex-row gap-2 space-y-0',
              radioGroupStackClass
            )}
            ref={ref}
          />
...
const AutocompleteField = React.memo(
  withControlledInput(
    forwardRef<HTMLInputElement, FieldComponent<AutocompleteProps>>(
      ({ onChange, ...props }, ref) => {
        return <Autocomplete {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);

const SimpleDropzoneField = React.memo(
  withControlledInput(
    forwardRef<HTMLInputElement, FieldComponent<SimpleDropzoneProps>>(
      ({ onChange, value, ...props }, ref) => {
        ...
        return <SimpleDropzone {...props} onValueChange={onChange} ref={ref} />;
      }
    )
  )
);

// type DirectorySelectorFieldProps = Omit<
//   DirectorySelectorProps,
//   'onSelect' | 'value'
// > & { value?: string };

// const DirectorySelectorField = React.memo(
//   withControlledInput(
//     forwardRef<HTMLInputElement, FieldComponent<DirectorySelectorFieldProps>>(
...
// type MultiDirectorySelectorFieldProps = Omit<
//   DirectorySelectorProps,
//   'onSelect' | 'value'
// > & { value?: string[] };

// const MultiDirectorySelectorField = React.memo(
//   withControlledInput(
//     forwardRef<
//       HTMLInputElement,
//       FieldComponent<MultiDirectorySelectorFieldProps>
...
//                 icon={<BiTrash />}
//                 onClick={() =>
//                   setPaths((prev) => prev.filter((_, index) => index !== i))
//                 }
//               />
//             </div>
//           ))}
...
// const MediaExclusionSelectorField = React.memo(
//   withControlledInput(
//     forwardRef<HTMLDivElement, FieldComponent<MediaExclusionSelectorProps>>(
//       ({ onChange, ...props }, ref) => {
//         return (
//           <MediaExclusionSelector {...props} onChange={onChange} ref={ref} />
//         );
//       }
//     )
//   )
...
export const Field = createPolymorphicComponent<
  'div',
  FieldProps,
  {
    Text: typeof TextInputField;
    Password: typeof PasswordInputField;
