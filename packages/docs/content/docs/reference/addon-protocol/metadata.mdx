---
title: Metadata
description: Extra meta, catalog entry and video fields AIOStreams reads, and what each one shows in a Jellyfin client.
---

These fields sit alongside the Stremio ones on a catalog entry, a meta, or a video. Put them on
catalog entries too where you can: lists are built without opening each title.
