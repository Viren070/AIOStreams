...
| `{stream.audioTitles}`   | string[] | Names of the probed audio tracks (e.g. `VFF`, `Descriptive`) |
...
| `{stream.subtitleTitles}`      | string[] | Names of the probed subtitle tracks (e.g. `SDH`, `VFQ (Forced)`)                                      |
