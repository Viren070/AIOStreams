...
| `MAX_SAME_RELEASE_FAILOVER_COUNT` | Max Same Release Failover Count | number | `5` | Maximum same-release variant failover attempts a user can configure per release. |
