...
| Variable                            | Default | Description                                                                                                                 |
| ----------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------- |
| `AIOSTREAMS_AUTH`                   | —       | Comma-separated `username:password` pairs for the AIOStreams instance (currently used by the built-in proxy and NZB proxy). |
| `AIOSTREAMS_AUTH_ADMINS`            | —       | Comma-separated usernames (from `AIOSTREAMS_AUTH`) that are admins. If unset, all users are admins.                         |
| `AIOSTREAMS_AUTH_CONNECTIONS_LIMIT` | —       | Comma-separated `username:limit` connection limits (`-1` / `0` for unlimited) for the built-in proxy.                       |
...
| `TRUSTED_IPS` | Trusted Ips | json | `["172.17.0.0/16","127.0.0.1/32","::1/128"]` | Comma-separated list of trusted IPs / CIDR ranges. Used when determining the requesting IP. User IP is always trusted via headers regardless of this setting. |
...
| `DEFAULT_PROXY_URL` | Default › URL | json | — | Default proxy URL. |
| `DEFAULT_PROXY_PUBLIC_URL` | Default › Public URL | json | — | Public-facing default proxy URL surfaced to clients (when different from the internal one). |
...
| `DEFAULT_PROXY_PROXIED_SERVICES` | Default › Proxied Services | json | — | List of serviceIds to proxy by default. JSON array of strings. |
...
| `FORCE_PROXY_URL` | Force › URL | json | — | Override user choice of proxy URL. |
| `FORCE_PROXY_PUBLIC_URL` | Force › Public URL | json | — | Override user choice of proxy public URL. |
...
| `FORCE_PROXY_PROXIED_SERVICES` | Force › Proxied Services | json | — | List of serviceIds to force-proxy. JSON array of strings. |
...
| `DEFAULT_COMET_USER_AGENT` | Comet › Default User Agent | json | — | Default User-Agent for the Comet addon. Supports `{version}`/`{random}` placeholders. |
| `COMET_PUBLIC_API_TOKEN` | Comet › Public API Token | json | *(unset)* | Public API token(s) used by Comet. JSON array or single string. _(secret)_ |
...
| `DEFAULT_METEOR_USER_AGENT` | Meteor › Default User Agent | json | — | Default User-Agent for the Meteor addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_MEDIAFUSION_USER_AGENT` | Mediafusion › Default User Agent | json | — | Default User-Agent for the MediaFusion addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_JACKETTIO_USER_AGENT` | Jackettio › Default User Agent | json | — | Default User-Agent for the Jackettio addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_TORRENTIO_USER_AGENT` | Torrentio › Default User Agent | json | — | Default User-Agent for the Torrentio addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_ORION_USER_AGENT` | Orion › Default User Agent | json | — | Default User-Agent for the Orion addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_PEERFLIX_USER_AGENT` | Peerflix › Default User Agent | json | — | Default User-Agent for the Peerflix addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_TORBOX_USER_AGENT` | Torbox › Default User Agent | json | — | Default User-Agent for the Torbox addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_EASYNEWS_USER_AGENT` | Easynews › Default User Agent | json | — | Default User-Agent for the Easynews addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_EASYNEWS_PLUS_USER_AGENT` | Easynews Plus › Default User Agent | json | — | Default User-Agent for the Easynews+ addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_EASYNEWS_PLUS_PLUS_USER_AGENT` | Easynews Plus Plus › Default User Agent | json | — | Default User-Agent for the Easynews++ addon. Supports `{version}`/`{random}` placeholders. |
| `EASYNEWS_PLUS_PLUS_PUBLIC_URL` | Easynews Plus Plus › Public URL | json | — | Public-facing URL surfaced to clients (when different from the internal one). |
...
| `DEFAULT_DEBRIDIO_USER_AGENT` | Debridio › Default User Agent | json | — | Default User-Agent for the Debridio addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_DEBRIDIO_TVDB_USER_AGENT` | Debridio TVDB › Default User Agent | json | — | Default User-Agent for the Debridio TVDB addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_DEBRIDIO_TMDB_USER_AGENT` | Debridio TMDB › Default User Agent | json | — | Default User-Agent for the Debridio TMDB addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_DEBRIDIO_TV_USER_AGENT` | Debridio Tv › Default User Agent | json | — | Default User-Agent for the Debridio TV addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_DEBRIDIO_WATCHTOWER_USER_AGENT` | Debridio Watchtower › Default User Agent | json | — | Default User-Agent for the Debridio Watchtower addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_DEBRIDIO_IC4A_USER_AGENT` | Debridio Ic4a › Default User Agent | json | — | Default User-Agent for the Debridio IC4A addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_STREMTHRU_STORE_USER_AGENT` | Stremthru Store › Default User Agent | json | — | Default User-Agent for the StremThru Store addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_STREMTHRU_TORZ_USER_AGENT` | Stremthru Torz › Default User Agent | json | — | Default User-Agent for the StremThru Torz addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_STREAMFUSION_USER_AGENT` | Streamfusion › Default User Agent | json | — | Default User-Agent for the StreamFusion addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_SOOTIO_USER_AGENT` | Sootio › Default User Agent | json | — | Default User-Agent for the Sootio addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_DMM_CAST_USER_AGENT` | Dmm Cast › Default User Agent | json | — | Default User-Agent for the DMM Cast addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_OPENSUBTITLES_USER_AGENT` | Opensubtitles › Default User Agent | json | — | Default User-Agent for the OpenSubtitles addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_OPENSUBTITLES_V3_PLUS_USER_AGENT` | Opensubtitles V3 Plus › Default User Agent | json | — | Default User-Agent for the OpenSubtitles V3+ addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_MARVEL_CATALOG_USER_AGENT` | Marvel Universe › Default User Agent | json | — | Default User-Agent for the Marvel Universe addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_DC_UNIVERSE_USER_AGENT` | Dc Universe › Default User Agent | json | — | Default User-Agent for the DC Universe addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_STAR_WARS_UNIVERSE_USER_AGENT` | Star Wars Universe › Default User Agent | json | — | Default User-Agent for the Star Wars Universe addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_ANIME_KITSU_USER_AGENT` | Anime Kitsu › Default User Agent | json | — | Default User-Agent for the Anime Kitsu addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_NUVIOSTREAMS_USER_AGENT` | Nuvio Streams › Default User Agent | json | — | Default User-Agent for the NuvioStreams addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_TORRENT_CATALOGS_USER_AGENT` | Torrent Catalogs › Default User Agent | json | — | Default User-Agent for the Torrent Catalogs addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_TMDB_COLLECTIONS_USER_AGENT` | TMDB Collections › Default User Agent | json | — | Default User-Agent for the TMDB Collections addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_RPDB_CATALOGS_USER_AGENT` | RPDB Catalogs › Default User Agent | json | — | Default User-Agent for the RPDB Catalogs addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_STREAMING_CATALOGS_USER_AGENT` | Streaming Catalogs › Default User Agent | json | — | Default User-Agent for the Streaming Catalogs addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_ANIME_CATALOGS_USER_AGENT` | Anime Catalogs › Default User Agent | json | — | Default User-Agent for the Anime Catalogs addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_DOCTOR_WHO_UNIVERSE_USER_AGENT` | Doctor Who Universe › Default User Agent | json | — | Default User-Agent for the Doctor Who Universe addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_WEBSTREAMR_USER_AGENT` | Webstreamr › Default User Agent | json | — | Default User-Agent for the WebStreamr addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_HDHUB_USER_AGENT` | Hdhub › Default User Agent | json | — | Default User-Agent for the HdHub addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_BAGUETTIO_USER_AGENT` | Baguettio › Default User Agent | json | — | Default User-Agent for the Baguettio addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_TMDB_ADDON_USER_AGENT` | TMDB Addon › Default User Agent | json | — | Default User-Agent for the TMDB Addon addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_TORRENTS_DB_USER_AGENT` | Torrents DB › Default User Agent | json | — | Default User-Agent for the Torrents DB addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_USA_TV_USER_AGENT` | Usa Tv › Default User Agent | json | — | Default User-Agent for the USA TV addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_ARGENTINA_TV_USER_AGENT` | Argentina Tv › Default User Agent | json | — | Default User-Agent for the Argentina TV addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_BRAZUCA_TORRENTS_USER_AGENT` | Brazuca Torrents › Default User Agent | json | — | Default User-Agent for the Brazuca Torrents addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_SUBDL_USER_AGENT` | Subdl › Default User Agent | json | — | Default User-Agent for the SubDL addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_SUBSOURCE_USER_AGENT` | Subsource › Default User Agent | json | — | Default User-Agent for the SubSource addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_AI_SEARCH_USER_AGENT` | Ai Search › Default User Agent | json | — | Default User-Agent for the AI Search addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_FLIX_STREAMS_USER_AGENT` | Flix Streams › Default User Agent | json | — | Default User-Agent for the Flix-Streams addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_FKSTREAM_USER_AGENT` | Fkstream › Default User Agent | json | — | Default User-Agent for the FKStream addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_AIOSUBTITLE_USER_AGENT` | Aio Subtitle › Default User Agent | json | — | Default User-Agent for the AIOSubtitle addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_SUBHERO_USER_AGENT` | Subhero › Default User Agent | json | — | Default User-Agent for the SubHero addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_YASTREAM_USER_AGENT` | Yastream › Default User Agent | json | — | Default User-Agent for the yastream addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_STREAMASIA_USER_AGENT` | Streamasia › Default User Agent | json | — | Default User-Agent for the StreamAsia addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_MORE_LIKE_THIS_USER_AGENT` | More Like This › Default User Agent | json | — | Default User-Agent for the More Like This addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_CONTENT_DEEP_DIVE_USER_AGENT` | Content Deep Dive › Default User Agent | json | — | Default User-Agent for the Content Deep Dive addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_AI_COMPANION_USER_AGENT` | Ai Companion › Default User Agent | json | — | Default User-Agent for the AI Companion addon. Supports `{version}`/`{random}` placeholders. |
...
| `DEFAULT_ASTREAM_USER_AGENT` | Astream › Default User Agent | json | — | Default User-Agent for the AStream addon. Supports `{version}`/`{random}` placeholders. |
...
| `BUILTIN_DEBRID_METADATA_STORE` | Debrid › Metadata Store | json | — | Backend used to persist debrid metadata. Defaults to the platform-default when unset. _(restart required)_ |
...
| Environment Variable | UI Setting | Type | Default | Description |
| --- | --- | --- | --- | --- |
| `BUILTIN_BITMAGNET_URL` | Bitmagnet › URL | json | — | Base URL for the Bitmagnet built-in addon. |
...
| Environment Variable | UI Setting | Type | Default | Description |
| --- | --- | --- | --- | --- |
| `BUILTIN_JACKETT_URL` | Jackett › URL | json | — | Base URL for the Jackett built-in addon. |
...
| Environment Variable | UI Setting | Type | Default | Description |
| --- | --- | --- | --- | --- |
| `BUILTIN_NZBHYDRA_URL` | Nzbhydra › URL | json | — | Base URL for the NZBHydra built-in addon. |
...
| Environment Variable | UI Setting | Type | Default | Description |
| --- | --- | --- | --- | --- |
| `BUILTIN_PROWLARR_URL` | Prowlarr › URL | json | — | Base URL for the Prowlarr built-in addon. |
