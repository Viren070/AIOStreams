...
| Environment Variable                 | UI Setting                   | Type     | Default                     | Description                                              |
| ------------------------------------ | ---------------------------- | -------- | --------------------------- | -------------------------------------------------------- |
| `BUILTIN_TSUKIHIME_URL`              | Tsukihime › URL              | string   | `https://api.tsukihime.org` | Base URL for the TsukiHime built-in addon.               |
| `BUILTIN_DEFAULT_TSUKIHIME_TIMEOUT`  | Tsukihime › Default Timeout  | number   | —                           | Default timeout for TsukiHime requests.                  |
| `BUILTIN_TSUKIHIME_SEARCH_TIMEOUT`   | Tsukihime › Search Timeout   | number   | `30000`                     | Timeout for TsukiHime search requests.                   |
| `BUILTIN_TSUKIHIME_SEARCH_CACHE_TTL` | Tsukihime › Search Cache TTL | duration | `604800`                    | Cache TTL for TsukiHime search results.                  |
| `BUILTIN_TSUKIHIME_PAGE_LIMIT`       | Tsukihime › Page Limit       | number   | `5`                         | Maximum pages fetched when paginating TsukiHime results. |
