...
| `BUILTIN_NAB_EMPTY_RESULT_CACHE_TTL` | NAB › Empty Result Cache TTL        | duration | `1800`                          | Cache TTL for Newznab/Torznab searches that returned zero results. Set to 0 to never cache empty results. |
