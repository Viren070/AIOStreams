...
| `BUILTIN_DEBRID_GLOBAL_TIMEOUT`                 | Debrid › Global Timeout                 | number   | `10000`                                                               | Timeout for most debrid API calls (lookups/status checks).                                                           |
| `BUILTIN_DEBRID_ADD_TIMEOUT`                    | Debrid › Add Timeout                    | number   | `30000`                                                               | Timeout for the slower debrid "add" calls (e.g. adding a magnet or NZB for download).                                |
