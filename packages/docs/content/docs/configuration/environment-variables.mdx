...
| Environment Variable             | UI Setting                       | Type   | Default                                   | Description                                                                                            |
| -------------------------------- | -------------------------------- | ------ | ----------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `TORRENTCLAW_URL`                | Torrentclaw › URL                | list   | `["https://torrentclaw.com/api/stremio"]` | Upstream URL(s) for the TorrentClaw addon.                                                             |
| `DEFAULT_TORRENTCLAW_TIMEOUT`    | Torrentclaw › Default Timeout    | number | —                                         | Default timeout for the TorrentClaw addon (milliseconds). Falls back to the global default when unset. |
| `DEFAULT_TORRENTCLAW_USER_AGENT` | Torrentclaw › Default User Agent | string | —                                         | Default User-Agent for the TorrentClaw addon. Supports `{version}`/`{random}` placeholders.            |
...
| Environment Variable               | UI Setting                | Type     | Default      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------------------------------- | ------------------------- | -------- | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `USENET_PROVIDERS`                 | Providers                 | json     | _(unset)_    | JSON array of NNTP provider objects: &#123; id, name?, host, port, tls, tlsSkipVerify?, username?, password?, maxConnections, priority, backupTier?, isBackup?, enabled? &#125;. Legacy isBackup=true is read as backupTier=1. _(secret)_                                                                                                                                                                                                                               |
