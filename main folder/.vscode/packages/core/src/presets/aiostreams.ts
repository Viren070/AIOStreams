...
export class AIOStreamsPreset extends Preset {
  ...
  static override get METADATA() {
    ...
    return {
      ...
      URL: options.find(opt => opt.id === 'manifestUrl')?.default || 'https://example.com/manifest.json',
      TIMEOUT: typeof Env.DEFAULT_TIMEOUT === 'number' && !isNaN(Env.DEFAULT_TIMEOUT) ? Env.DEFAULT_TIMEOUT : 10000,
      USER_AGENT: Env.DEFAULT_USER_AGENT || 'AIOStreams/unknown',
      SUPPORTED_SERVICES: [],
