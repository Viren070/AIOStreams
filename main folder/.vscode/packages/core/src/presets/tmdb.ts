...
export class TMDBAddonPreset extends Preset {
  static override get METADATA() {
    ...
    return {
      ...
      URL: Env.TMDB_ADDON_URL || 'https://example.com/manifest.json',
      TIMEOUT: (typeof Env.DEFAULT_TMDB_ADDON_TIMEOUT === 'number' && !isNaN(Env.DEFAULT_TMDB_ADDON_TIMEOUT)) ? Env.DEFAULT_TMDB_ADDON_TIMEOUT : (typeof Env.DEFAULT_TIMEOUT === 'number' && !isNaN(Env.DEFAULT_TIMEOUT) ? Env.DEFAULT_TIMEOUT : 10000),
      USER_AGENT: Env.DEFAULT_TMDB_ADDON_USER_AGENT || Env.DEFAULT_USER_AGENT || 'AIOStreams/unknown',
      SUPPORTED_SERVICES: [],
