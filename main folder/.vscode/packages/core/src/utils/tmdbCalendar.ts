    ...
    for (const movie of movies) {
      ...
      items.push({
        ...
        metaItem: {
          ...
          type: 'movie',
          poster: movie.poster_path ? `https://image.tmdb.org/t/p/original${movie.poster_path}` : undefined,
    ...
    for (const show of shows) {
      ...
      items.push({
        ...
        metaItem: {
          ...
          type: 'series',
          poster: show.poster_path ? `https://image.tmdb.org/t/p/original${show.poster_path}` : undefined,
